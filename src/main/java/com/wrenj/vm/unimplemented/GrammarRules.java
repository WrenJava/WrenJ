...
public class GrammarRules {
    ...
    public GrammarRules() {
        ...
        this.grammarRules = new GrammarRule[]{
                ...
                /* TOKEN_LEFT_BRACKET  */ new GrammarRule(list, subscript, subscriptSignature, PREC_CALL, null),
                ...
                /* TOKEN_DOTDOT        */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_RANGE, ".."), //FIXME::implement infix callbacks
                /* TOKEN_DOTDOTDOT     */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_RANGE, "..."), //FIXME::implement infix callbacks
                /* TOKEN_COMMA         */ new GrammarRule(null, null, null, Precedence.PREC_NONE, null),
                /* TOKEN_STAR          */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_FACTOR, "*"), //FIXME::implement infix callbacks
                /* TOKEN_SLASH         */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_FACTOR, "/"), //FIXME::implement infix callbacks
                /* TOKEN_PERCENT       */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_FACTOR, "%"), //FIXME::implement infix callbacks
                /* TOKEN_HASH          */ new GrammarRule(null, null, null, Precedence.PREC_NONE, null),
                /* TOKEN_PLUS          */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_TERM, "+"), //FIXME::implement infix callbacks
                /* TOKEN_MINUS         */ new GrammarRule(unaryOp, infixOp, mixedSignature, Precedence.PREC_TERM, "-"),
                /* TOKEN_LTLT          */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_BITWISE_SHIFT, "<<"), //FIXME::implement infix callbacks
                /* TOKEN_GTGT          */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_BITWISE_SHIFT, ">>"), //FIXME::implement infix callbacks
                /* TOKEN_PIPE          */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_BITWISE_OR, "|"), //FIXME::implement infix callbacks
                /* TOKEN_PIPEPIPE      */ new GrammarRule(null, or_, null, Precedence.PREC_LOGICAL_OR, null),
                /* TOKEN_CARET         */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_BITWISE_XOR, "^"), //FIXME::implement infix callbacks
                /* TOKEN_AMP           */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_BITWISE_AND, "&"), //FIXME::implement infix callbacks
                /* TOKEN_AMPAMP        */ new GrammarRule(null, and_, null, Precedence.PREC_LOGICAL_AND, null),
                /* TOKEN_BANG          */ new GrammarRule(unaryOp, null, unarySignature, Precedence.PREC_NONE, "!"), //FIXME::implement unary callbacks
                /* TOKEN_TILDE         */ new GrammarRule(unaryOp, null, unarySignature, Precedence.PREC_NONE, "~"), //FIXME::implement unary callbacks
                ...
                /* TOKEN_LT            */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_COMPARISON, "<"), //FIXME::implement infix callbacks
                /* TOKEN_GT            */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_COMPARISON, ">"), //FIXME::implement infix callbacks
                /* TOKEN_LTEQ          */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_COMPARISON, "<="), //FIXME::implement infix callbacks
                /* TOKEN_GTEQ          */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_COMPARISON, ">="), //FIXME::implement infix callbacks
                /* TOKEN_EQEQ          */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_EQUALITY, "=="), //FIXME::implement infix callbacks
                /* TOKEN_BANGEQ        */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_EQUALITY, "!="), //FIXME::implement infix callbacks
                ...
                /* TOKEN_IS            */ new GrammarRule(null, infixOp, infixSignature, Precedence.PREC_IS, "is"), //FIXME::implement infix callbacks
